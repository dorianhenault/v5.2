...
import ptidej_solver_tests.ptidej.solver.test.data.pattern.InheritanceTest;
			...
			GoodInheritance.BuiltSolutions =
				this
					.testDesignPattern(
						...
						((IDesignMotifModel) InheritanceTest.class
							.newInstance()).getName(),
						ptidej_solver_tests.ptidej.solver.test.data.source.InheritanceTest.class,
