...
import ptidej_solver_tests.ptidej.solver.test.data.pattern.StrictInheritanceTest;
import ptidej_solver_tests.ptidej.solver.test.data.source.InheritanceTest;
