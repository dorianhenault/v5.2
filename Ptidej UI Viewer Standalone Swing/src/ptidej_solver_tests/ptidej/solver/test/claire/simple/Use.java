...
import ptidej_solver_tests.ptidej.solver.test.data.pattern.UseTest;
			...
			Use.BuiltSolutions =
				this
					.testDesignPattern(
						...
						((IDesignMotifModel) UseTest.class
							.newInstance()).getName(),
						ptidej_solver_tests.ptidej.solver.test.data.source.UseTest.class,
