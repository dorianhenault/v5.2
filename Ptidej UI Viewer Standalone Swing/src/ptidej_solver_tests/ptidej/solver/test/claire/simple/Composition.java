 ...
 ******************************************************************************/
package ptidej_solver_tests.ptidej.solver.test.claire.simple;

import junit.framework.Assert;
import padl.motif.IDesignMotifModel;
import ptidej_.ptidej.solver.Occurrence;
import ptidej_.ptidej.solver.OccurrenceGenerator;
import ptidej_solver_tests.ptidej.solver.test.claire.Primitive;
import ptidej_solver_tests.ptidej.solver.test.data.pattern.CompositionTest;
		...
		this.builtSolutions =
			this
				.testDesignPattern(
					...
					((IDesignMotifModel) CompositionTest.class
						.newInstance()).getName(),
					ptidej_solver_tests.ptidej.solver.test.data.source.CompositionTest.class,
