...
import ptidej_solver_tests.ptidej.solver.test.data.pattern.CreationTest;
			...
			Creation.BuiltSolutions =
				this
					.testDesignPattern(
						...
						((IDesignMotifModel) CreationTest.class
							.newInstance()).getName(),
						ptidej_solver_tests.ptidej.solver.test.data.source.CreationTest.class,
