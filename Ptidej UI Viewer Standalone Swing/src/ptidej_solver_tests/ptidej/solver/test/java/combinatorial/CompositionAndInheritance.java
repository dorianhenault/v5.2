 ...
 ******************************************************************************/
package ptidej_solver_tests.ptidej.solver.test.java.combinatorial;

import junit.framework.Assert;
import ptidej_.ptidej.solver.Occurrence;
import ptidej_solver_tests.ptidej.solver.test.data.problem.CompositionAndInheritanceTest;
import ptidej_solver_tests.ptidej.solver.test.java.Primitive;
	...
	protected void setUp() {
		if (CompositionAndInheritance.BuiltSolutions == null) {
			CompositionAndInheritance.BuiltSolutions =
				Primitive
					.automaticSolve(
						CompositionAndInheritanceTest.class,
						ptidej_solver_tests.ptidej.solver.test.data.source.CompositionAndInheritanceTest.class);
		}
	}
