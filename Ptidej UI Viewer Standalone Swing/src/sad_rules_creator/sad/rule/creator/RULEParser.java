...
import sad_rules_creator.sad.rule.creator.javacup.runtime.lr_parser;
...
import sad_rules_creator.sad.rule.creator.model.impl.Factory;
import sad_rules_creator.sad.rule.creator.utils.Constants;
import sad_rules_creator.sad.rule.creator.visitor.GhostRuleCleaner;
			...
			case 67 : // string ::= IDENTIFIER 
				{
					...
					final java.lang.String n =
						(java.lang.String) ((Symbol) CUP$RULEParser$stack
			...
			case 58 : // relationship ::= name_relation TWO_DOT string FROM TWO_DOT string cardinality TO TWO_DOT string cardinality 
				{
					...
					final String name =
						(String) ((Symbol) CUP$RULEParser$stack
...
/** CUP v0.10k generated parser.
  ...
  */
public class RULEParser extends lr_parser {
	...
	public RULEParser(final Scanner s) {
		super(s);
	}
